...
func (eu *EventUpdate) SetIsCritical(b bool) *EventUpdate {
	eu.mutation.SetIsCritical(b)
	return eu
}

// SetNillableIsCritical sets the "is_critical" field if the given value is not nil.
func (eu *EventUpdate) SetNillableIsCritical(b *bool) *EventUpdate {
	if b != nil {
		eu.SetIsCritical(*b)
	}
	return eu
...
// SetNillablePreferredChannel sets the "preferred_channel" field if the given value is not nil.
func (eu *EventUpdate) SetNillablePreferredChannel(s *string) *EventUpdate {
	if s != nil {
...
func (eu *EventUpdate) check() error {
	...
	if v, ok := eu.mutation.PreferredChannel(); ok {
...
// SetIsCritical sets the "is_critical" field.
func (euo *EventUpdateOne) SetIsCritical(b bool) *EventUpdateOne {
	euo.mutation.SetIsCritical(b)
	return euo
}

// SetNillableIsCritical sets the "is_critical" field if the given value is not nil.
func (euo *EventUpdateOne) SetNillableIsCritical(b *bool) *EventUpdateOne {
	if b != nil {
		euo.SetIsCritical(*b)
	}
	return euo
...
// SetNillablePreferredChannel sets the "preferred_channel" field if the given value is not nil.
func (euo *EventUpdateOne) SetNillablePreferredChannel(s *string) *EventUpdateOne {
	if s != nil {
...
func (euo *EventUpdateOne) check() error {
	...
	if v, ok := euo.mutation.PreferredChannel(); ok {
		if err := event.PreferredChannelValidator(v); err != nil {
			return &ValidationError{Name: "preferred_channel", err: fmt.Errorf(`ent: validator failed for field "Event.preferred_channel": %w`, err)}
		}
	}
